...
export class CvComponent {
  ...
  skillsItems = [
    ...
    { category: 'Data Science', skills: 'Python, Pandas, scikit‑learn, RF, SVM, XGBoost, ZenML, SQLAlchemy' },
    { category: 'Software Engineering', skills: 'Flask, Angular, REST APIs, Docker, Git, Azure, Full‑Stack' }
  ];
  educationItems = [
